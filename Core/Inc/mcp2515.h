...
/* Pin configuration. Modify below items for your SPI configurations */
extern SPI_HandleTypeDef        hspi2;
#define SPI_CAN                 &hspi2
#define SPI_TIMEOUT             20
#define MCP2515_CS_HIGH()   HAL_GPIO_WritePin(GPIOH, GPIO_PIN_6, GPIO_PIN_SET)		// CS pin D10
#define MCP2515_CS_LOW()    HAL_GPIO_WritePin(GPIOH, GPIO_PIN_6, GPIO_PIN_RESET)	// CS pin D10
